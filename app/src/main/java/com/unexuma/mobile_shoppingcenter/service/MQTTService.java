...
import com.unexuma.mobile_shoppingcenter.resource.EventResource;
import com.unexuma.mobile_shoppingcenter.resource.StatusResource;
			...
			case "Event":
                try {
                    EventResponse eventresponse = gson.fromJson(String.valueOf(data), EventResponse.class);
                     Exception error = new EventResource(getApplicationContext()).executeMethod(eventresponse);
			...
			case "Status":
                try {
                    StatusResponse statusresponse = gson.fromJson(String.valueOf(data), StatusResponse.class);
                     Exception error = new StatusResource(getApplicationContext()).executeMethod(statusresponse);
